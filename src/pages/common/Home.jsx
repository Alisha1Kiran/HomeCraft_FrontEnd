...
const Home = () => {
  return (
    ...
    <Link to="/accessories/living room/lighting" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Lighting</Link>
      <Link to="/furniture/living room/tv unit" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">TV unit</Link>
      <Link to="/furniture/living room/sofas" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Sofas</Link>
      <Link to="/furniture/living room/coffee table" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Coffee Table</Link>
      <Link to="/accessories/living room/floor covering" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Floor covering</Link>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 m-2 text-2xl font-semibold text-purple-100 text-center">
      <Link to="/furniture/dining room/ dining table" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Dining tables</Link>
      <Link to="/furniture/dining room/ dining sets" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Dining sets</Link>
      <Link to="/furniture/dining room/ dining chairs" className="bg-gradient-to-bl from-blue-500 to-cyan-950 m-2 p-2 rounded-2xl">Dining Chairs</Link>
    </div>
    </div>
    ...
    >
      <div className="hero-content text-neutral-content text-center">
        <div className="">
          ...
          <Link to="/accessories/utility and storage" className="btn btn-primary">
            Shope Now
          </Link>
        </div>
      </div>
